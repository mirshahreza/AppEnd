...
/// <summary>
/// Pushes commits to remote Git repository.
/// </summary>
[Activity(
...
public class GitPushChangesActivity : CodeActivity
{
    ...
    [Input(Description = "Branch to push")]
    ...
    [Output(Description = "Whether push succeeded")]
