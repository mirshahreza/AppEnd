...
- For Vue.js or React projects that require static file serving, build them and then use ASP.NET Core middleware (`UseStaticFiles`) to serve the output. This pattern is better for isolation and security.
- Whenever changes are made to the React app, run the build automatically.
