<template>
    <div class="card h-100 rounded-bottom-0 rounded-end-0  border-0">
        <div class="card-body p-2">
            <div class="card h-100 border-light bg-opacity-75 border-0">
                <div class="card-body rounded rounded-2 border border-3 border-light fs-d8 p-0 ">
        ...
        <div class="card-footer p-2 rounded-bottom-0 fs-d8">
