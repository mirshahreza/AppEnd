...
<div class="card h-100 bg-transparent rounded-0 border-0">
		<div class="card-header p-2 bg-success-subtle rounded-0 border-0">
			<div class="hstack gap-1">
				...
				<div class="vr"></div>
				<button type="button" class="btn btn-sm border-0 btn-outline-success px-2" data-ae-actions="DefaultRepo.AAA_Users.Create" @click="localOpenCreate">
		...
		<div class="simple-search card-header p-2 bg-transparent rounded-0 collapse">
			<div class="row">
				...
				<div class="col-48 col-md-6">
					<input type="text" class="form-control" id="input_Settings" @keyup.enter="localCrudLoadRecords" v-model="searchOptions.Settings" :placeholder="shared.translate('Settings')">
				</div>
				<div class="col-48 col-md-6">
						...
						<thead>
							<tr class="d-none d-md-table-row d-lg-table-row d-xl-table-row">
								...
								<td class="sticky-top ae-thead-td " style="min-width:185px;">
									<div>{{shared.translate("Email")}}</div>
								</td>
								<td class="sticky-top ae-thead-td " style="min-width:185px;">
									<div>{{shared.translate("Mobile")}}</div>
								</td>
								<td class="sticky-top ae-thead-td text-center" style="width:75px;overflow: hidden;text-overflow: ellipsis;">
									<div>{{shared.translate("LoginTryFails")}}</div>
								</td>
								<td class="sticky-top ae-thead-td " style="min-width:185px;">
								...
								<td class="sticky-top ae-thead-td " style="min-width:185px;">
									<div>{{shared.translate("LoginTryUpdate")}}</div>
								</td>
						...
						<tbody>
							<tr v-for="i in initialResponses[0]['Result']['Master']">
								...
								<td class="ae-table-td   pointer" style="min-width:185px;" @click="localCrudOpenById('/a.DbComponents/DefaultRepo_AAA_Users_LoginLockedUpdate','modal-md',i.Id,true,'DefaultRepo.AAA_Users.LoginLockedUpdate','');">
									<div class="input-group input-group-sm bg-hover-primary rounded-2 p-2">
										<div class="input-group-text rounded-2 me-1">
											<span v-html="shared.convertBoolToIconWithOptions(i.LoginLocked ,{})"></span>
										</div>
										<div class="more-info" style="">
											<table class="w-100 h-100 fs-d7">
												<tbody>
								...
								<td class="ae-table-td   pointer" style="min-width:185px;" @click="localCrudOpenById('/a.DbComponents/DefaultRepo_AAA_Users_LoginTryUpdate','modal-md',i.Id,true,'DefaultRepo.AAA_Users.LoginTryUpdate','');">
									<div class="input-group input-group-sm bg-hover-primary rounded-2 p-2">
										<div class="input-group-text rounded-2 me-1">
										...
										<div class="more-info" style="">
											<table class="w-100 h-100 fs-d7">
												<tbody>
													<tr>
														<td class="text-muted align-middle">{{shared.translate("LoginTryOn")}}</td>
														<td class="text-dark fb align-middle">
...
_this.orderableColumns = ["Id","UserName","Picture_FileSize","PasswordUpdatedBy","IsActiveUpdatedBy","LoginTryFails","CreatedBy","UpdatedBy","CreatedOn","UpdatedOn"];
...
_this.searchOptions = {"Id":null,"IsBuiltIn":null,"UserName":null,"Email":null,"Mobile":null,"Picture_FileName":null,"Picture_FileSize":null,"Picture_FileMime":null,"IsActive":null,"IsActiveUpdatedBy":null,"LoginLocked":null,"LoginTry":null,"LoginTryFails":null,"Settings":null,"CreatedBy":null,"UpdatedBy":null};
_this.clientQueryMetadata = {"ParentObjectColumns":[{"Name":"Id","DevNote":"","IsPrimaryKey":true,"DbType":"INT","IsIdentity":true,"IdentityStart":"100000","IdentityStep":"1","UpdateGroup":"","UiProps":{"Group":"","UiWidget":"Textbox","UiWidgetOptions":"{}","SearchType":"Expandable","IsDisabled":true,"Required":true,"ValidationRule":":=i(0,10000)"}},{"Name":"IsBuiltIn","DevNote":"","DbType":"BIT","DbDefault":"0","UpdateGroup":"","UiProps":{"Group":"","UiWidget":"Checkbox","UiWidgetOptions":"{}","SearchType":"Expandable","Required":true}},{"Name":"UserName","DevNote":"","DbType":"NVARCHAR","Size":"64","IsHumanId":true,"UpdateGroup":"","UiProps":{"Group":"","UiWidget":"Textbox","UiWidgetOptions":"{}","SearchType":"Expandable","Required":true}},{"Name":"Email","DevNote":"","DbType":"VARCHAR","Size":"64","AllowNull":true,"UpdateGroup":"","UiProps":{"Group":"","UiWidget":"Textbox","UiWidgetOptions":"{}","SearchType":"Expandable","Required":false}},{"Name":"Mobile","DevNote":"","DbType":"VARCHAR","Size":"14","AllowNull":true,"UpdateGroup":"","UiProps":{"Group":"","UiWidget":"Textbox","UiWidgetOptions":"{}","SearchType":"Expandable","Required":false}},{"Name":"Picture_FileBody","DevNote":"","DbType":"IMAGE","AllowNull":true,"UpdateGroup":"","UiProps":{"Group":"","UiWidget":"ImageView","UiWidgetOptions":"{}","Required":false}},{"Name":"Picture_FileBody_xs","DevNote":"","DbType":"IMAGE","AllowNull":true,"UpdateGroup":"","UiProps":{"Group":"","UiWidget":"ImageView","UiWidgetOptions":"{}","Required":false}},{"Name":"Picture_FileName","DevNote":"","DbType":"NVARCHAR","Size":"128","AllowNull":true,"UpdateGroup":"","UiProps":{"Group":"","UiWidget":"Textbox","UiWidgetOptions":"{}","SearchType":"Expandable","Required":false}},{"Name":"Picture_FileSize","DevNote":"","DbType":"INT","AllowNull":true,"UpdateGroup":"","UiProps":{"Group":"","UiWidget":"Textbox","UiWidgetOptions":"{}","SearchType":"Expandable","Required":false,"ValidationRule":":=i(0,10000)"}},{"Name":"Picture_FileMime","DevNote":"","DbType":"VARCHAR","Size":"32","AllowNull":true,"UpdateGroup":"","UiProps":{"Group":"","UiWidget":"Textbox","UiWidgetOptions":"{}","SearchType":"Expandable","Required":false}},{"Name":"IsActive","DevNote":"","DbType":"BIT","DbDefault":"1","UpdateGroup":"IsActiveUpdate","UiProps":{"Group":"","UiWidget":"Checkbox","UiWidgetOptions":"{}","SearchType":"Expandable","Required":true}},{"Name":"IsActiveUpdatedBy","DevNote":"","DbType":"INT","AllowNull":true,"UpdateGroup":"IsActiveUpdate","UiProps":{"Group":"","UiWidget":"Textbox","UiWidgetOptions":"{}","SearchType":"Expandable","Required":false,"ValidationRule":":=i(0,10000)"}},{"Name":"IsActiveUpdatedOn","DevNote":"","DbType":"DATETIME","AllowNull":true,"UpdateGroup":"IsActiveUpdate","UiProps":{"Group":"","UiWidget":"DateTimePicker","UiWidgetOptions":"{}","Required":false,"ValidationRule":"dt(1900-01-01 00:01:00,2100-12-30 11:59:59)"}},{"Name":"LoginLocked","DevNote":"","DbType":"BIT","DbDefault":"0","UpdateGroup":"LoginLockedUpdate","UiProps":{"Group":"","UiWidget":"Checkbox","UiWidgetOptions":"{}","SearchType":"Expandable","Required":true}},{"Name":"LoginLockedUpdatedOn","DevNote":"","DbType":"DATETIME","AllowNull":true,"UpdateGroup":"LoginLockedUpdate","UiProps":{"Group":"","UiWidget":"DateTimePicker","UiWidgetOptions":"{}","Required":false,"ValidationRule":"dt(1900-01-01 00:01:00,2100-12-30 11:59:59)"}},{"Name":"LoginTry","DevNote":"","DbType":"BIT","AllowNull":true,"UpdateGroup":"LoginTryUpdate","UiProps":{"Group":"","UiWidget":"Checkbox","UiWidgetOptions":"{}","SearchType":"Expandable","Required":false}},{"Name":"LoginTryFails","DevNote":"","DbType":"INT","AllowNull":true,"DbDefault":"0","UpdateGroup":"","UiProps":{"Group":"","UiWidget":"Textbox","UiWidgetOptions":"{}","SearchType":"Expandable","Required":false,"ValidationRule":":=i(0,10000)"}},{"Name":"LoginTryOn","DevNote":"","DbType":"DATETIME","AllowNull":true,"UpdateGroup":"LoginTryUpdate","UiProps":{"Group":"","UiWidget":"DateTimePicker","UiWidgetOptions":"{}","Required":false,"ValidationRule":"dt(1900-01-01 00:01:00,2100-12-30 11:59:59)"}},{"Name":"Settings","DevNote":"","DbType":"NTEXT","AllowNull":true,"UpdateGroup":"","UiProps":{"Group":"","UiWidget":"MultilineTextbox","UiWidgetOptions":"{}","SearchType":"Expandable","Required":false}},{"Name":"CreatedBy","DevNote":"","DbType":"INT","UpdateGroup":"","UiProps":{"Group":"Auditing","UiWidget":"DisabledTextbox","UiWidgetOptions":"{}","SearchType":"Expandable","IsDisabled":true,"Required":true,"ValidationRule":":=i(0,10000)"}},{"Name":"CreatedOn","DevNote":"","DbType":"DATETIME","UpdateGroup":"","UiProps":{"Group":"Auditing","UiWidget":"DisabledTextbox","UiWidgetOptions":"{}","IsDisabled":true,"Required":true,"ValidationRule":"dt(1900-01-01 00:01:00,2100-12-30 11:59:59)"}},{"Name":"UpdatedBy","DevNote":"","DbType":"INT","AllowNull":true,"UpdateGroup":"","UiProps":{"Group":"Auditing","UiWidget":"DisabledTextbox","UiWidgetOptions":"{}","SearchType":"Expandable","IsDisabled":true,"Required":false,"ValidationRule":":=i(0,10000)"}},{"Name":"UpdatedOn","DevNote":"","DbType":"DATETIME","AllowNull":true,"UpdateGroup":"","UiProps":{"Group":"Auditing","UiWidget":"DisabledTextbox","UiWidgetOptions":"{}","IsDisabled":true,"Required":false,"ValidationRule":"dt(1900-01-01 00:01:00,2100-12-30 11:59:59)"}}],"Name":"ReadList","Type":"ReadList","QueryColumns":["Id","IsBuiltIn","UserName","Email","Mobile","Picture_FileBody_xs","IsActive","IsActiveUpdatedBy","IsActiveUpdatedOn","LoginLocked","LoginLockedUpdatedOn","LoginTry","LoginTryFails","LoginTryOn","CreatedBy","CreatedOn","UpdatedBy","UpdatedOn"],"FastSearchColumns":[],"ExpandableSearchColumns":[{"Name":"Id","DevNote":"","IsPrimaryKey":true,"DbType":"INT","IsIdentity":true,"IdentityStart":"100000","IdentityStep":"1","UpdateGroup":"","UiProps":{"Group":"","UiWidget":"Textbox","UiWidgetOptions":"{}","SearchType":"Expandable","IsDisabled":true,"Required":true,"ValidationRule":":=i(0,10000)"}},{"Name":"IsBuiltIn","DevNote":"","DbType":"BIT","DbDefault":"0","UpdateGroup":"","UiProps":{"Group":"","UiWidget":"Checkbox","UiWidgetOptions":"{}","SearchType":"Expandable","Required":true}},{"Name":"UserName","DevNote":"","DbType":"NVARCHAR","Size":"64","IsHumanId":true,"UpdateGroup":"","UiProps":{"Group":"","UiWidget":"Textbox","UiWidgetOptions":"{}","SearchType":"Expandable","Required":true}},{"Name":"Email","DevNote":"","DbType":"VARCHAR","Size":"64","AllowNull":true,"UpdateGroup":"","UiProps":{"Group":"","UiWidget":"Textbox","UiWidgetOptions":"{}","SearchType":"Expandable","Required":false}},{"Name":"Mobile","DevNote":"","DbType":"VARCHAR","Size":"14","AllowNull":true,"UpdateGroup":"","UiProps":{"Group":"","UiWidget":"Textbox","UiWidgetOptions":"{}","SearchType":"Expandable","Required":false}},{"Name":"Picture_FileName","DevNote":"","DbType":"NVARCHAR","Size":"128","AllowNull":true,"UpdateGroup":"","UiProps":{"Group":"","UiWidget":"Textbox","UiWidgetOptions":"{}","SearchType":"Expandable","Required":false}},{"Name":"Picture_FileSize","DevNote":"","DbType":"INT","AllowNull":true,"UpdateGroup":"","UiProps":{"Group":"","UiWidget":"Textbox","UiWidgetOptions":"{}","SearchType":"Expandable","Required":false,"ValidationRule":":=i(0,10000)"}},{"Name":"Picture_FileMime","DevNote":"","DbType":"VARCHAR","Size":"32","AllowNull":true,"UpdateGroup":"","UiProps":{"Group":"","UiWidget":"Textbox","UiWidgetOptions":"{}","SearchType":"Expandable","Required":false}},{"Name":"IsActive","DevNote":"","DbType":"BIT","DbDefault":"1","UpdateGroup":"IsActiveUpdate","UiProps":{"Group":"","UiWidget":"Checkbox","UiWidgetOptions":"{}","SearchType":"Expandable","Required":true}},{"Name":"IsActiveUpdatedBy","DevNote":"","DbType":"INT","AllowNull":true,"UpdateGroup":"IsActiveUpdate","UiProps":{"Group":"","UiWidget":"Textbox","UiWidgetOptions":"{}","SearchType":"Expandable","Required":false,"ValidationRule":":=i(0,10000)"}},{"Name":"LoginLocked","DevNote":"","DbType":"BIT","DbDefault":"0","UpdateGroup":"LoginLockedUpdate","UiProps":{"Group":"","UiWidget":"Checkbox","UiWidgetOptions":"{}","SearchType":"Expandable","Required":true}},{"Name":"LoginTry","DevNote":"","DbType":"BIT","AllowNull":true,"UpdateGroup":"LoginTryUpdate","UiProps":{"Group":"","UiWidget":"Checkbox","UiWidgetOptions":"{}","SearchType":"Expandable","Required":false}},{"Name":"LoginTryFails","DevNote":"","DbType":"INT","AllowNull":true,"DbDefault":"0","UpdateGroup":"","UiProps":{"Group":"","UiWidget":"Textbox","UiWidgetOptions":"{}","SearchType":"Expandable","Required":false,"ValidationRule":":=i(0,10000)"}},{"Name":"Settings","DevNote":"","DbType":"NTEXT","AllowNull":true,"UpdateGroup":"","UiProps":{"Group":"","UiWidget":"MultilineTextbox","UiWidgetOptions":"{}","SearchType":"Expandable","Required":false}},{"Name":"CreatedBy","DevNote":"","DbType":"INT","UpdateGroup":"","UiProps":{"Group":"Auditing","UiWidget":"DisabledTextbox","UiWidgetOptions":"{}","SearchType":"Expandable","IsDisabled":true,"Required":true,"ValidationRule":":=i(0,10000)"}},{"Name":"UpdatedBy","DevNote":"","DbType":"INT","AllowNull":true,"UpdateGroup":"","UiProps":{"Group":"Auditing","UiWidget":"DisabledTextbox","UiWidgetOptions":"{}","SearchType":"Expandable","IsDisabled":true,"Required":false,"ValidationRule":":=i(0,10000)"}}],"OptionalQueries":[]};
