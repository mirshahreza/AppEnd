...
<div class="card h-100 bg-transparent rounded-0 border-0">
		<div class="card-header p-2 bg-success-subtle rounded-0 border-0">
			<div class="hstack gap-1">
				...
				<div class="vr"></div>
				<button type="button" class="btn btn-sm border-0 btn-outline-success px-2" data-ae-actions="DefaultRepo.ZzEntity.Create" @click="localOpenCreate">
		...
		<div class="simple-search card-header p-2 bg-transparent rounded-0 collapse">
			<div class="row">
				...
				<div class="col-48 col-md-6">
					<input type="text" class="form-control" id="input_ColNum" @keyup.enter="localCrudLoadRecords" v-model="searchOptions.ColNum" :placeholder="shared.translate('ColNum')">
				</div>
				<div class="col-48 col-md-6">
					...
					<table class="table table-sm table-hover w-100 ae-table m-0 bg-transparent">
						<thead>
							<tr class="d-none d-md-table-row d-lg-table-row d-xl-table-row">
								...
								<td class="sticky-top ae-thead-td " style="min-width:185px;">
									<div>{{shared.translate("FldD")}}</div>
								</td>
								<td class="sticky-top ae-thead-td " style="min-width:185px;">
									<div>{{shared.translate("FldDT")}}</div>
								</td>
						...
						<tbody>
							<tr v-for="i in initialResponses[0]['Result']['Master']">
								...
								<td class="ae-table-td " style="min-width:185px;">
									<div>{{shared.formatDate(i["FldD"])}}</div>
								</td>
								<td class="ae-table-td " style="min-width:185px;">
									<div>{{shared.formatDateTime(i["FldDT"])}}</div>
								</td>
...
_this.orderableColumns = ["Id","MyTestField","ColNum"];
...
_this.searchOptions = {"MyTestField":"","Id":null,"Note":null,"ColNum":null};
_this.clientQueryMetadata = {"ParentObjectColumns":[{"Name":"Id","DevNote":"","IsPrimaryKey":true,"DbType":"INT","IsIdentity":true,"IdentityStart":"1","IdentityStep":"1","UpdateGroup":"","UiProps":{"Group":"","UiWidget":"Textbox","UiWidgetOptions":"{}","SearchType":"Expandable","IsDisabled":true,"Required":true,"ValidationRule":":=i(0,10000)"}},{"Name":"MyTestField","DevNote":"","DbType":"INT","AllowNull":true,"Fk":{"FkName":"ZzEntity_MyTestField_Common_BaseInfo_Id","TargetTable":"Common_BaseInfo","TargetColumn":"Id","Lookup":{"Id":"MyTestField_Lookup","Method":"DefaultRepo.Common_BaseInfo.ReadList","Inputs":{"ClientQueryJE":{"QueryFullName":"DefaultRepo.Common_BaseInfo.ReadList","Where":{"CompareClauses":[{"Name":"ParentId","Value":10000,"ClauseOperator":"Equal"}]},"OrderClauses":[{"Name":"ViewOrder","OrderDirection":"ASC"}],"Pagination":{"PageNumber":1,"PageSize":500},"IncludeSubQueries":false}}}},"UpdateGroup":"","UiProps":{"Group":"","UiWidget":"Combo","UiWidgetOptions":"{}","SearchType":"Fast","Required":false,"ValidationRule":":=i(0,10000)"}},{"Name":"Note","DevNote":"","DbType":"NVARCHAR","Size":"256","AllowNull":true,"UpdateGroup":"","UiProps":{"Group":"","UiWidget":"CodeEditorbox","UiWidgetOptions":"{\n    \u0022mode\u0022: \u0022ace/mode/csharp\u0022\n}","SearchType":"Expandable","Required":false}},{"Name":"ColNum","DevNote":"","DbType":"INT","AllowNull":true,"UpdateGroup":"","UiProps":{"Group":"","UiWidget":"Sliderbox","UiWidgetOptions":"{}","SearchType":"Expandable","Required":true,"ValidationRule":":=i(880,10000)"}},{"Name":"FldD","DevNote":"","DbType":"DATE","AllowNull":true,"UpdateGroup":"","UiProps":{"Group":"","UiWidget":"DatePicker","UiWidgetOptions":"{}","Required":false,"ValidationRule":"d(1900-01-01,2100-12-30)"}},{"Name":"FldDT","DevNote":"","DbType":"DATETIME","AllowNull":true,"UpdateGroup":"","UiProps":{"Group":"","UiWidget":"DateTimePicker","UiWidgetOptions":"{}","Required":false,"ValidationRule":"dt(1900-01-01 00:01:00,2100-12-30 11:59:59)"}}],"Name":"ReadList","Type":"ReadList","QueryColumns":["Note","Id","MyTestField","FldD","FldDT"],"FastSearchColumns":[{"Name":"MyTestField","DevNote":"","DbType":"INT","AllowNull":true,"Fk":{"FkName":"ZzEntity_MyTestField_Common_BaseInfo_Id","TargetTable":"Common_BaseInfo","TargetColumn":"Id","Lookup":{"Id":"MyTestField_Lookup","Method":"DefaultRepo.Common_BaseInfo.ReadList","Inputs":{"ClientQueryJE":{"QueryFullName":"DefaultRepo.Common_BaseInfo.ReadList","Where":{"CompareClauses":[{"Name":"ParentId","Value":10000,"ClauseOperator":"Equal"}]},"OrderClauses":[{"Name":"ViewOrder","OrderDirection":"ASC"}],"Pagination":{"PageNumber":1,"PageSize":500},"IncludeSubQueries":false}}}},"UpdateGroup":"","UiProps":{"Group":"","UiWidget":"Combo","UiWidgetOptions":"{}","SearchType":"Fast","Required":false,"ValidationRule":":=i(0,10000)"}}],"ExpandableSearchColumns":[{"Name":"Id","DevNote":"","IsPrimaryKey":true,"DbType":"INT","IsIdentity":true,"IdentityStart":"1","IdentityStep":"1","UpdateGroup":"","UiProps":{"Group":"","UiWidget":"Textbox","UiWidgetOptions":"{}","SearchType":"Expandable","IsDisabled":true,"Required":true,"ValidationRule":":=i(0,10000)"}},{"Name":"Note","DevNote":"","DbType":"NVARCHAR","Size":"256","AllowNull":true,"UpdateGroup":"","UiProps":{"Group":"","UiWidget":"CodeEditorbox","UiWidgetOptions":"{\n    \u0022mode\u0022: \u0022ace/mode/csharp\u0022\n}","SearchType":"Expandable","Required":false}},{"Name":"ColNum","DevNote":"","DbType":"INT","AllowNull":true,"UpdateGroup":"","UiProps":{"Group":"","UiWidget":"Sliderbox","UiWidgetOptions":"{}","SearchType":"Expandable","Required":true,"ValidationRule":":=i(880,10000)"}}],"OptionalQueries":[]};
