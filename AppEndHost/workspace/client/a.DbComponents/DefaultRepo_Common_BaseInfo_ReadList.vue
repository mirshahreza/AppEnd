<template>
	<div class="card h-100 bg-transparent rounded-0 border-0">
				...
				<div class="col-48 col-md-6">
					<div class="form-control form-control-sm py-0 data-ae-validation">
						<div class="input-group input-group-sm p-0 pt-1" data-ae-widget="objectPicker">
							...
							<input type="text" class="form-control bg-transparent p-0 m-0 border-0" :value="shared.fixNull(searchOptions.ParentId+' '+searchOptions.ParentId_Title,'',true)" :placeholder="shared.translate('ParentId')" disabled="">
							<span>&nbsp;</span>
		...
		<div class="simple-search card-header p-2 bg-transparent rounded-0 collapse">
			<div class="row">
				<div class="col-48 col-md-6">
					<input type="text" class="form-control form-control-sm" id="input_ShortName" @keyup.enter="loadRecords" v-model="searchOptions.ShortName" :placeholder="shared.translate('ShortName')">
				</div>
				<div class="col-48 col-md-6">
...
_this.searchOptions = {"ParentId":"","Title":null,"Id":null,"CreatedBy":null,"UpdatedBy":null,"ShortName":null,"ViewOrder":null,"Note":null,"Metadata":null,"IsActive":null,"UiColor":null,"UiIcon":null};
