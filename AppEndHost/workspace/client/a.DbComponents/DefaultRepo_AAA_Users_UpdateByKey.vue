			...
			<div class="row">
				...
				<div class="card rounded-1 border-light mb-1">
					<div class="card-body">
						<div class="row">
							<div class="col-48">
								<div class="form-control mt-2 pointer text-nowrap data-ae-validation disabled" data-ae-widget="nullableCheckbox" data-ae-widget-options="{    &quot;shownull&quot;: true,    &quot;nullClasses&quot;: &quot;fa-minus text-secondary&quot;,    &quot;trueClasses&quot;: &quot;fa-lock text-danger&quot;,    &quot;falseClasses&quot;: &quot;fa-lock-open text-success&quot;}">
							...
							<div class="col-48">
								<div class="form-control mt-2 pointer text-nowrap data-ae-validation disabled" data-ae-widget="nullableCheckbox" data-ae-widget-options="">
									<i class="fa-solid fa-fw me-1"></i>
