<template>
    <div class="control-designer h-100 d-flex flex-column">
        ...
        <div class="designer-content flex-grow-1 d-flex" data-flex-splitter-horizontal style="flex: auto;">
            ...
            <ControlDesigner_Toolbox v-if="toolboxPanelVisible"
...
<script>
    ...
    import ControlDesigner_Toolbox from './ControlDesigner_Toolbox.vue';

    export default {
        components: {
            ControlDesigner_Toolbox
        },
        data() {
            return {
                cid: "",
...
<style scoped>
    ...
    /* Write and modify styles in the file: a..lib/append-client.css */
