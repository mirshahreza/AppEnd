	...
	<div class="card h-100 bg-transparent rounded-0 border-0">
		<div class="card-header p-2 bg-success-subtle rounded-0 border-0">
			<div class="row">
				...
				<div class="col-48 col-md-6">
					<input type="text" class="form-control form-control-sm" id="input_UserName" @keyup.enter="loadRecords" v-model="searchOptions.UserName" :placeholder="shared.translate('UserName')">
				</div>
			</div>
		</div>
		...
		<div class="simple-search card-header p-2 bg-transparent rounded-0 collapse">
			<div class="row">
				...
				<div class="col-48 col-md-6">
					<input type="text" class="form-control form-control-sm" id="input_Email" @keyup.enter="loadRecords" v-model="searchOptions.Email" :placeholder="shared.translate('Email')">
				</div>
				<div class="col-48 col-md-6">
					<input type="text" class="form-control form-control-sm" id="input_Mobile" @keyup.enter="loadRecords" v-model="searchOptions.Mobile" :placeholder="shared.translate('Mobile')">
				</div>
			</div>
		...
		<div class="card-header p-2 rounded-0">
			<div class="hstack gap-1">
				...
				<button type="button" class="btn btn-sm border-0 btn-outline-success px-2" data-ae-actions="DefaultRepo.AAA_Users.Create" @click="openCreate({compPath:'/a.UserComponents/DefaultRepo_AAA_Users_Create'})">
					...
					<table class="table table-sm table-hover w-100 ae-table m-0 bg-transparent">
						...
						<tbody v-if="initialResponses[0].IsSucceeded===true">
							<tr v-for="i in initialResponses[0]['Result']['Master']">
								<td class="ae-table-td text-dark text-center" @click="openById({compPath:'/a.UserComponents/DefaultRepo_AAA_Users_UpdateByKey',recordKey:i.Id,refereshOnCallback:true,actionsAllowed:'DefaultRepo.AAA_Users.UpdateByKey',fkToParent:''});">
									...
									<div class="input-group input-group-sm bg-hover-primary rounded-2 p-2">
										...
										<div class="more-info" style="">
											<table class="w-100 h-100 fs-d8">
												<tbody>
													<tr>
														<td class="text-muted align-middle" style="width:45px;">{{shared.translate("Fails")}}</td>
														<td class="text-dark fb align-middle">
															<span class="fw-bold">{{shared.fixNull(i["LoginTryFails"],'-')}}</span>
														</td>
													</tr>
													<tr>
														<td class="text-muted align-middle" style="width:45px;">{{shared.translate("Last")}}</td>
														<td class="text-dark fb align-middle">
								...
								<td class="ae-table-td pointer" @click="openById({compPath:'/a.UserComponents/DefaultRepo_AAA_Users_IsActiveUpdate',recordKey:i.Id,refereshOnCallback:true,actionsAllowed:'DefaultRepo.AAA_Users.IsActiveUpdate',fkToParent:''});">
									<div class="input-group input-group-sm bg-hover-primary rounded-2 p-2">
										<div class="input-group-text rounded-2 me-1">
								...
								<td class="ae-table-td pointer" @click="openById({compPath:'/a.UserComponents/DefaultRepo_AAA_Users_LoginLockedUpdate',recordKey:i.Id,refereshOnCallback:true,actionsAllowed:'DefaultRepo.AAA_Users.LoginLockedUpdate',fkToParent:''});">
									<div class="input-group input-group-sm bg-hover-primary rounded-2 p-2">
										<div class="input-group-text rounded-2 me-1">
...
_this.searchOptions = {"UserName":null,"Id":null,"CreatedBy":null,"UpdatedBy":null,"IsBuiltIn":null,"Email":null,"Mobile":null,"Picture_FileName":null,"Picture_FileSize":null,"Picture_FileMime":null,"IsActive":null,"IsActiveUpdatedBy":null,"LoginLocked":null,"LoginTry":null,"LoginTryFails":null,"Settings":null};
