...
<script>
    ...
    _this.folders = [
        ...
        { "link": "a.Components", "title": "Db Components", "note": "Components generated by template engine" },
        { "link": "a.Layouts", "title": "Layouts", "note": "Layout files used to call directly as a page" },
        { "link": "a..templates", "title": "Templates", "note": "Used by template engine to generate database components" }
    ];
    export default {
        methods: {
            create() {
