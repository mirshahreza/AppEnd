...
<div class="card h-100 bg-transparent rounded-0 border-0">
		...
		<div class="card-body bg-primary-subtle-light scrollable" id="formArea" data-ae-widget="inputsRegulator" data-ae-widget-options='{}'>
			...
			<div class="card rounded-1 border-light mb-1">
				<div class="card-body">
					<div class="row">
						<div class="col-48" id="container_Age">
							<label class="fs-d8 text-muted ms-2" for="input_Age">{{shared.translate('Age')}}</label>
							<input type="text" class="form-control form-control-sm text-center" style="direction:ltr !important" id="input_Age" v-model="row.Age" data-ae-validation-required="false" data-ae-validation-rule=":=i(0,2147483647)">
						</div>
					</div>
				</div>
			</div>
...
_this.masterRequest = {"Id":"","Method":"DefaultRepo.Test.ReadByKey","Inputs":{"ClientQueryJE":{"QueryFullName":"DefaultRepo.Test.ReadByKey","Params":[{"Name":"Id","Value":""}]}}};
