				...
				<div class="card-body">
					<div class="row">
						...
						<div class="col-48">
							...
							<input type="text" class="form-control form-control-sm" id="input_LandPhone" v-model="row.LandPhone" data-ae-validation-required="false" data-ae-validation-rule=":=s(0,16)">
						</div>
					</div>
				</div>
			</div>
...
_this.submitMethod = "CompTestUpdate";
_this.createComponent = "";
_this.updateComponent = "";

_this.masterRequest = {"Id":"","Method":"DefaultRepo.BasePersons.CompTestReadByKey","Inputs":{"ClientQueryJE":{"QueryFullName":"DefaultRepo.BasePersons.CompTestReadByKey","Params":[{"Name":"Id","Value":""}]}}};
