		...
		<div class="card-header simple-search p-2 px-0 bg-transparent rounded-0 border-0 collapse">
			<div class="container-fluid">
				<div class="row">
					...
					<div class="col-48 col-md-6">
						<input type="text" class="form-control form-control-sm" id="input_GenderId" @keyup.enter="loadRecords()" v-model="filter.GenderId" :placeholder="shared.translate('GenderId')">
					</div>
					<div class="col-48 col-md-6">
...
_this.filter = {"FirstName":null,"LastName":null,"Id":null,"CreatedBy":null,"UpdatedBy":null,"UserId":null,"GenderId":null,"NationalCode":null,"BirthYear":null,"BirthMonth":null,"BirthDay":null,"Mobile":null,"Picture_FileName":null,"Picture_FileSize":null,"Picture_FileMime":null};
