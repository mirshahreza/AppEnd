...
<div class="card h-100 bg-transparent rounded-0 border-0">
		...
		<div class="card-header simple-search p-2 bg-transparent rounded-0 collapse">
			<div class="row">
				...
				<div class="col-48 col-md-6">
					<input type="text" class="form-control form-control-sm" id="input_AttributeId" @keyup.enter="loadRecords" v-model="filter.AttributeId" :placeholder="shared.translate('AttributeId')">
				</div>
				<div class="col-48 col-md-6">
		...
		<div class="card-header p-2 rounded-0">
			<div class="hstack gap-1">
				...
				<button type="button" class="btn btn-sm border-0 btn-outline-success px-2" data-ae-actions="DefaultRepo.AAA_Users_Attributes.Create" @click="openCreate()">
				...
				<div class="vr"></div>
				<div class="btn btn-sm border-0 btn-outline-success px-2" data-ae-actions="DefaultRepo.AAA_Users_Attributes.ReadList" @click="exportExcel">
					...
					<table class="table table-sm table-hover table-striped table-bordered w-100 ae-table m-0 fs-d8">
						<thead>
							<tr class="d-none d-md-table-row d-lg-table-row d-xl-table-row">
								...
								<th class="sticky-top ae-thead-th text-center" style="width:75px;overflow: hidden;text-overflow: ellipsis;">
									<div>{{shared.translate("AttributeId")}}</div>
								</th>
								<th class="sticky-top ae-thead-th"></th>
								<th style="width:40px;" class="sticky-top ae-thead-th text-center" data-ae-actions="DefaultRepo.AAA_Users_Attributes.DeleteByKey"></th>
							</tr>
						</thead>
						<tbody v-if="initialResponses[0].IsSucceeded===true">
							<tr v-for="i in initialResponses[0]['Result']['Master']">
								<td class="ae-table-td text-dark text-center" style="" @click="openById({compPath:'/a.Components/AAA_Users_Attributes_UpdateByKey',recordKey:i.Id,refereshOnCallback:true,actionsAllowed:'DefaultRepo.AAA_Users_Attributes.UpdateByKey',fkToParent:''});">
								...
								<td class="ae-table-td text-center" style="">
									<div>{{i["AttributeId"]}}</div>
								</td>
								<td></td>
								<td style="width:40px;vertical-align:middle" class="text-center text-secondary text-hover-danger pointer" data-ae-actions="DefaultRepo.AAA_Users_Attributes.DeleteByKey" @click="deleteById({pkValue:i.Id})">
...
_this.objectName = "AAA_Users_Attributes";
_this.loadMethod = "DefaultRepo.AAA_Users_Attributes.ReadList";
_this.filePrefix = "";
_this.deleteMethod = `${_this.dbConfName}.${_this.objectName}.DeleteByKey`;
_this.orderableColumns = ["AttributeId"];
_this.orderClauses = [{ Name: "AttributeId", OrderDirection: "ASC" }];
...
_this.filter = {"Id":null,"UserId":null,"AttributeId":null};
_this.initialSearchOptions = _.cloneDeep(_this.filter);
_this.clientQueryMetadata = {"ParentObjectColumns":[{"Name":"Id","DevNote":"","IsPrimaryKey":true,"DbType":"INT","IsIdentity":true,"IdentityStart":"1","IdentityStep":"1","UpdateGroup":"","UiProps":{"Group":"","UiWidget":"Textbox","UiWidgetOptions":"{}","SearchType":"Expandable","IsDisabled":true,"Required":true,"ValidationRule":":=i(0,2147483647)"}},{"Name":"UserId","DevNote":"","DbType":"INT","UpdateGroup":"","UiProps":{"Group":"","UiWidget":"Textbox","UiWidgetOptions":"{}","SearchType":"Expandable","Required":true,"ValidationRule":":=i(0,2147483647)"}},{"Name":"AttributeId","DevNote":"","DbType":"INT","IsSortable":true,"UpdateGroup":"","UiProps":{"Group":"","UiWidget":"Textbox","UiWidgetOptions":"{}","SearchType":"Expandable","Required":true,"ValidationRule":":=i(0,2147483647)"}}],"Name":"ReadList","Type":"ReadList","QueryColumns":["Id","UserId","AttributeId"],"FastSearchColumns":[],"ExpandableSearchColumns":[{"Name":"Id","DevNote":"","IsPrimaryKey":true,"DbType":"INT","IsIdentity":true,"IdentityStart":"1","IdentityStep":"1","UpdateGroup":"","UiProps":{"Group":"","UiWidget":"Textbox","UiWidgetOptions":"{}","SearchType":"Expandable","IsDisabled":true,"Required":true,"ValidationRule":":=i(0,2147483647)"}},{"Name":"UserId","DevNote":"","DbType":"INT","UpdateGroup":"","UiProps":{"Group":"","UiWidget":"Textbox","UiWidgetOptions":"{}","SearchType":"Expandable","Required":true,"ValidationRule":":=i(0,2147483647)"}},{"Name":"AttributeId","DevNote":"","DbType":"INT","IsSortable":true,"UpdateGroup":"","UiProps":{"Group":"","UiWidget":"Textbox","UiWidgetOptions":"{}","SearchType":"Expandable","Required":true,"ValidationRule":":=i(0,2147483647)"}}],"OptionalQueries":[]};
