				...
				<div class="row">
					<div class="col-48 col-md-12">
						<div class="form-control form-control-sm pb-0">
							<div class="form-check form-check-inline" v-for="i in shared.enum(150)">
								<input class="form-check-input" type="checkbox" v-model="filter.ContentTypeId" :value="i.Id" :id="i.Id+'ContentTypeId_Lookup'">
								<label class="form-check-label" :for="i.Id+'ContentTypeId_Lookup'">
									{{i.Title}}
								</label>
							</div>
						</div>
					...
					<table class="table table-sm table-hover w-100 ae-table m-0 bg-transparent fs-d8">
						...
						<tbody v-if="initialResponses[0].IsSucceeded===true">
							<tr v-for="i in initialResponses[0]['Result']['Master']">
								<td class="ae-table-td text-primary bg-hover-light text-center pointer" @click="openById({compPath:'/a.Components/CmsContents_UpdateByKey',recordKey:i.Id,refereshOnCallback:true,actionsAllowed:'DefaultRepo.CmsContents.UpdateByKey',fkColumn:''});">
								...
								<td class="ae-table-td ">
									<div>{{i["ContentTags"]}}</div>
								</td>
								<td class="ae-table-td   pointer" @click="openById({compPath:'/a.Components/CmsContents_RecordStateIdUpdate',recordKey:i.Id,refereshOnCallback:true,actionsAllowed:'DefaultRepo.CmsContents.RecordStateIdUpdate',fkColumn:''});">
										...
										<div class="more-info" style="">
											<table class="w-100 h-100 fs-d8">
												<tbody>
													...
													<tr>
														<td class="text-muted align-middle" style="min-width:65px;">{{shared.translate("RecordStateId_UiIcon")}}</td>
														<td class="text-dark fw-bold align-middle">
															<span class="fw-bold">{{shared.fixNull(i["RecordStateId_UiIcon"],'-')}}</span>
														</td>
													</tr>
													<tr>
														<td class="text-muted align-middle" style="min-width:65px;">{{shared.translate("RecordStateId_UiColor")}}</td>
														<td class="text-dark fw-bold align-middle">
															<span class="fw-bold">{{shared.fixNull(i["RecordStateId_UiColor"],'-')}}</span>
														</td>
													</tr>
													<tr>
														<td class="text-muted align-middle" style="min-width:65px;">{{shared.translate("RecordStateId_UiClass")}}</td>
														<td class="text-dark fw-bold align-middle">
															<span class="fw-bold">{{shared.fixNull(i["RecordStateId_UiClass"],'-')}}</span>
														</td>
													</tr>
													<tr>
														<td class="text-muted align-middle" style="min-width:65px;">{{shared.translate("RecordStateIdUpdatedBy_UserName")}}</td>
														<td class="text-dark fw-bold align-middle">
															<span class="fw-bold">{{shared.fixNull(i["RecordStateIdUpdatedBy_UserName"],'-')}}</span>
														</td>
													</tr>
												</tbody>
											</table>
...
_this.filter = {"ContentTypeId":[],"Title":null,"Id":null,"ParentId":null,"ViewOrder":null,"ParentsIds":null,"CreatedBy":null,"UpdatedBy":null,"Summary":null,"Body":null,"File_FileName":null,"File_FileSize":null,"File_FileMime":null,"LanguageId":"","RecordStateId":"","RecordStateIdUpdatedBy":null,"CommentsPolicyId":""};
_this.initialSearchOptions = _.cloneDeep(_this.filter);
_this.columns = [{"Name":"Id","DbType":"INT"},{"Name":"ParentId","DbType":"INT"},{"Name":"ViewOrder","DbType":"INT"},{"Name":"ParentsIds","DbType":"VARCHAR"},{"Name":"CreatedBy","DbType":"INT"},{"Name":"CreatedOn","DbType":"DATETIME"},{"Name":"UpdatedBy","DbType":"INT"},{"Name":"UpdatedOn","DbType":"DATETIME"},{"Name":"ContentTypeId","DbType":"VARCHAR"},{"Name":"Title","DbType":"NVARCHAR"},{"Name":"Summary","DbType":"NVARCHAR"},{"Name":"Body","DbType":"NTEXT"},{"Name":"File_FileBody","DbType":"IMAGE"},{"Name":"File_FileBody_xs","DbType":"IMAGE"},{"Name":"File_FileName","DbType":"NVARCHAR"},{"Name":"File_FileSize","DbType":"INT"},{"Name":"File_FileMime","DbType":"VARCHAR"},{"Name":"LanguageId","DbType":"VARCHAR"},{"Name":"RecordStateId","DbType":"VARCHAR"},{"Name":"RecordStateIdUpdatedBy","DbType":"INT"},{"Name":"RecordStateIdUpdatedOn","DbType":"DATETIME"},{"Name":"CommentsPolicyId","DbType":"VARCHAR"}];
